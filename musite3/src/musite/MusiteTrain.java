...
import musite.prediction.feature.InstanceTag;
...
//        ClosenessCalculator closenessCalculator = new MultiSimMatrixSequenceClosenessCalculator(knnWindowOffset); // adaptive matrix
    ...
    //        extractors.add(aabinaryextractor);
           ...
           /* 
            System.out.println("------begin------comments from musite.MusiteTrain---------------");
            System.out.println("For one protein: ");
            for(int m = 0; m < instances_positive.size(); m++)
            {
            	Map<String,Object> InstanceTagForOneInstance = instances_positive.get(m).getInstanceTag().getTagMap();
            	Map<String, List<Double>> featuresForOneInstance = instances_positive.get(m).getFeatureMap();
            	System.out.println(InstanceTagForOneInstance);
            	System.out.println(featuresForOneInstance);
            }
            System.out.println("-------end-----comments from musite.MusiteTrain---------------");
    	...
    	System.out.println();
    	System.out.println();
        System.out.println("@@@@@@@@@@@@@@@@@@@@@For instances_positive: ");
        for(int m = 0; m < instances_positive.size(); m++)
        {
        	Map<String,Object> InstanceTagForOneInstance = instances_positive.get(m).getInstanceTag().getTagMap();
        	Map<String, List<Double>> featuresForOneInstance = instances_positive.get(m).getFeatureMap();
        	System.out.println("---------------Fragment/Instance: "+ instances_positive.get(m).getInstanceContent());
        	System.out.println();
        	System.out.println("****Instance Tag");
        	System.out.println(InstanceTagForOneInstance);
        	System.out.println();
        	System.out.println("****Instance features");
        	System.out.println(featuresForOneInstance);
        	System.out.println();
        	System.out.println();
    	...
    	System.out.println();
    	System.out.println();
        System.out.println("@@@@@@@@@@@@@@@@@@@@@For instances_unlabeled: ");
        for(int m = 0; m < instances_unlabeled.size(); m++)
        {
        	Map<String,Object> InstanceTagForOneInstance = instances_unlabeled.get(m).getInstanceTag().getTagMap();
        	Map<String, List<Double>> featuresForOneInstance = instances_unlabeled.get(m).getFeatureMap();
        	System.out.println("---------------Fragment/Instance: "+ instances_unlabeled.get(m).getInstanceContent());
        	System.out.println();
        	System.out.println("****Instance Tag");
        	System.out.println(InstanceTagForOneInstance);
        	System.out.println();

        ...
        for (int site : sites) {
            ...
            if (extractors!=null) {
                for (FeatureExtractor extractor : extractors) {
                    ...
                    System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@extractor not null");
                }
            }
        }
       /*
        System.out.println("------begin------comments from musite/prediction.feature.InstancesExtractorFromProteins---------------");
        System.out.println("For one protein: ");
        for(int m = 0; m < instances.size(); m++)
        {
        	InstanceTag InstanceTagForOneInstance = instances.get(m).getInstanceTag();
        	Map<String, List<Double>> featuresForOneInstance = instances.get(m).getFeatureMap();
        	System.out.println(InstanceTagForOneInstance.getTagMap());
        	System.out.println(featuresForOneInstance);
        }
        System.out.println("-------end-----comments from musite/prediction.feature.InstancesExtractorFromProteins---------------");

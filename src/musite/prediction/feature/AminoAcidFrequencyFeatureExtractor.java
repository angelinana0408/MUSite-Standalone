...
public final class AminoAcidFrequencyFeatureExtractor implements FeatureExtractor, Serializable  {
    ...
    public List<Double> extract(final Instance instance, final boolean save) {
        ...
        //BY QIAO
        //save instance content to instance
        instance.putInstanceContent(sb.toString());
        ...
        /*
        InstanceTag InstanceTagForOneInstance = instance.getInstanceTag();
    	System.out.println(InstanceTagForOneInstance.getTagMap());
    	System.out.println(featureTag());

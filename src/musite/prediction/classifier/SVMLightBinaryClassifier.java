...
//        }
    ...
    private boolean prepareSVMLightTrainingData(final String tmpDirData,
        ...
        for (int i=0; i<np; i++) {
        	//Map<String,Object> InstanceTagForOneInstance = positives.get(i).getInstanceTag().getTagMap();
        ...
        if (featureNormalizer!=null) {
        	//The sentence below regular that each feature list of one instance must have same length, 
        	//but they may not have same size, so I set the sentence to comments
        ...
        try {
            ...
            for (int i=0; i<n; i++) {
                ...
                if (featureNormalizer!=null) {
                	//The sentence below regular that trainParameter function must run before this sentence
                	//since I deleted trainParameter function, I also set this sentence to comments
...
//            Process process = pb.start();
    ...
    private List<Double> extractFeature(Instance ins) {
    	...
    	//Map<String,Object> InstanceTagForOneInstance = ins.getInstanceTag().getTagMap();
        ...
        if (extractors!=null) {
            for (FeatureExtractor extractor : extractors) {
                ...
                //System.out.println(extractor.featureTag());
